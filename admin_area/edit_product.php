...
if(isset($_GET['edit_product'])){
    ...
    $product_category = $row_edit['p_cat_id'];
    ...
    $get_p_cat = "select * from product_categories where p_cat_id=' $product_category'";
               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="product_cat" class="form-control"><!-- form-control Begin -->
                              ...
                              <option value="<?php echo $product_cat;?>"> <?php echo  $p_cat_title;  ?></option>
                              <?php 
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="product_img1" type="file" class="form-control" value="" >
                          <br>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="product_keywords" type="text" class="form-control" value="<?php echo $product_keywords; ?>"required>
...
<?php 
  ...
  if(isset($_POST['update'])) {
    ...
    p_cat_id='$product_cat',date=NOW(),product_title='$product_title',product_img1='$product_img1',product_img2='$product_img2',product_img3='$product_img3',product_price='$product_price',product_keywords='$product_keywords',product_desc='$product_desc' where product_id='$product_id'";
