                ...
                <div class="box-header"> <!-- box-header begin -->
                  <center> <!-- center-->
                   <head>Register</head>
                    ...
                    <form action="customer_register.php" method="post" ectype="multipart/form-data"><!-- form begin -->
                      ...
                      <div class="form-group"> <!-- form group begin -->
                        ...
                        <input type="text" class="form-control" name="customer_regno" required>
                      </div> <!-- form-group finish finish -->
                      <div class="form-group"> <!-- form group begin -->
                      ...
                      <div class="form-group"> <!-- form group begin -->
                        ...
                        <input type="text" class="form-control" name="customer_course" required>
                      </div> <!-- form-group finish finish -->
                      <div class="form-group"> <!-- form group begin -->
                        <label for="">Year of Study</label>
                        <input type="text" class="form-control" name="customer_yearofstudy" required>
                      </div> <!-- form-group finish finish -->
                      <div class="form-group"> <!-- form group begin -->
                      ...
                      <div class="form-group"><!-- form group begin -->
                       <label >Profile picture</label>
                        <input type="file" class="form-control form-height-custom" name="customer_profile" required >
...
if(isset($_POST['register'])){
  ...
  $customer_regno = $_POST['customer_regno'];
  $customer_email = $_POST['customer_email'];
  $customer_course = $_POST['customer_course'];
  $customer_yearofstudy = $_POST['customer_yearofstudy'];
  $customer_contact = $_POST['customer_contact'];
  $customer_profile = $_FILES['customer_profile']['name'];
  $customer_profile_tmp = $_FILES['customer_profile']['tmp_name'];
  $customer_pass = $_POST['customer_pass'];
  $customer_ip = getRealIpUser();

  move_uploaded_file( $customer_profile_tmp ,"customer/customer_images/ $customer_profile");



  $insert_customer = "insert into customers
  (customer_name,customer_regno,customer_email,customer_course,customer_yearofstudy,customer_contact,customer_profile,customer_pass,customer_ip) values 
  ('$customer_name','$customer_regno','$customer_email','$customer_course','$customer_yearofstudy','$customer_contact','$customer_profile','$customer_pass','$customer_ip')";
  ...
  if($check_cart>0){
    ...
    echo "<script> window.open('checkout.php','_self')</script>";
        ...
        ///if register has no items in the cart
    $_SESSION['customer_email'] = $customer_email;
    echo "<script> alert('You have registerd successfully')</script>";
